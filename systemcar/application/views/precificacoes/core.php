        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-header">
                    <?php echo (isset($precificacao) ? '<i class="far fa-clock "></i>&nbsp;Last update:&nbsp;' . formata_data_banco_com_hora($precificacao->precificacao_data_alteracao) : ''); ?>
                </div>
                <div class="card-body">
                    <form class="forms-sample" name="form_core" method="POST">
                            ...
                            <div class="col-md-2 mb-20">
                                ...
                                <select class="form-control" name="precificacao_ativa">
                                    <?php if (isset($precificacao)) : ?>
                                        <option value="0"<?php echo ($precificacao->precificacao_ativa == 0 ? 'selected' : '') ?>>No</option>
                                        <option value="1"<?php echo ($precificacao->precificacao_ativa == 1 ? 'selected' : '') ?>>Yes</option>
                                    <?php else: ?>
                        ...
                        <?php endif; ?>
                        <button type="submit" class="btn btn-primary mr-2">&nbsp;<i class="far fa-save"></i> Save</button>
                        <a class="btn btn-info" href="<?php echo base_url($this->router->fetch_class()); ?>">&nbsp;<i class="fas fa-arrow-circle-right"></i> Back</a>
                    </form>
                </div>
                </div>
            </div>
