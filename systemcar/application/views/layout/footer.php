                    ...
                    <div class="modal-body d-flex align-items-center">
                        <div class="container">
                            <div class="apps-wrap">
                                ...
                                <div class="app-item">
                                    <a href="<?php echo base_url('estacionar'); ?>"><i class="fas fa-parking"></i><span>Parking</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="<?php echo base_url('mensalistas'); ?>"><i class="fas fa-users"></i><span>Monthly Clients</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="<?php echo base_url('mensalidades'); ?>"><i class="fas fa-hand-holding-usd"></i><span>Monthly Fees</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="<?php echo base_url('usuarios'); ?>"><i class="fas fa-user"></i><span>Users</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="<?php echo base_url('precificacoes'); ?>"><i class="ik ik-dollar-sign"></i><span>Pricings</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="<?php echo base_url('formas'); ?>"><i class="fas fa-comment-dollar"></i><span>Payment Methods</span></a>
                                </div>
                                <div class="app-item">
                                    <a href="<?php echo base_url('sistema'); ?>"><i class="ik ik-settings"></i><span>System</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
