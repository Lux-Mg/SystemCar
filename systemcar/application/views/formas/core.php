        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-header">
                    <?php echo (isset($forma) ? '<i class="far fa-clock "></i>&nbsp;Last update:&nbsp;' . formata_data_banco_com_hora($forma->forma_pagamento_data_alteracao) : ''); ?>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 mb-20">
                                ...
                                <select class="form-control" name="forma_pagamento_ativa">
                                    <?php if (isset($forma)) : ?>
                                        <option value="0"<?php echo ($forma->forma_pagamento_ativa == 0 ? 'selected' : '') ?>>No</option>
                                        <option value="1"<?php echo ($forma->forma_pagamento_ativa == 1 ? 'selected' : '') ?>>Yes</option>
                                    <?php else: ?>
