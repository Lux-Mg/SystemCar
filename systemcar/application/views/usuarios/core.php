            ...
            <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                <div class="card-header"><?php echo (isset($usuario) ? '<i class="far fa-clock "></i>&nbsp;Last update:&nbsp;' .formata_data_banco_com_hora ($usuario->data_ultima_alteracao) : ''); ?></div>
                                    <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <?php if($this->ion_auth->is_admin()): ?>
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <option value="2"<?php echo ($perfil_usuario->id == 2 ? 'selected' : '')?>>Attendant</option>
                                                <option value="1"<?php echo ($perfil_usuario->id == 1 ? 'selected' : '')?>>Administrator</option>
                                                ...
                                                <option value="1"<?php echo ($usuario->active == 1 ? 'selected' : '')?>>Yes</option>
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">Copyright © <?php echo date('Y'); ?> System Car. All rights reserved.</span>
