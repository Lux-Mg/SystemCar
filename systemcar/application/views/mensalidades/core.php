...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><?php echo (isset($mensalidade) ? '<i class="far fa-clock "></i>&nbsp;Last update:&nbsp;' .formata_data_banco_com_hora($mensalidade->mensalidade_data_alteracao) : ''); ?></div>
                    <div class="card-body">
                        ...
                        <form class="forms-sample" name="form_core" method="post">
                                    ...
                                    <select class="form-control mensalistas select2" name="mensalidade_mensalista_id" <?php echo (isset($mensalidade) ? 'disabled' : ''); ?>>
                                        ...
                                        <?php foreach ($mensalistas as $mensalista): ?>
                                            <?php if (isset($mensalidade)): ?>
                                                <option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalista_dia_vencimento ?>" <?php echo ($mensalista->mensalista_id == $mensalidade->mensalidade_mensalista_id ? 'selected' : '') ?>>
                                                    <?php echo $mensalista->mensalista_nome; ?>
                                                </option>                                                
                                            <?php else: ?>
                                                <option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalista_dia_vencimento ?>">
                                                    <?php echo $mensalista->mensalista_nome; ?>
                                                </option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-8 mb-3">
                                    ...
                                    <select class="form-control precificacao select2" name="mensalidade_precificacao_id" <?php echo (isset($mensalidade) && $mensalidade->mensalidade_status == 1 ? 'disabled' : ''); ?>>
                                        ...
                                        <?php foreach ($precificacoes as $preco): ?>
                                            <?php if (isset($mensalidade)): ?>
                                                <option value="<?php echo $preco->precificacao_id . ' ' . $preco->precificacao_valor_mensalidade ?>" <?php echo ($preco->precificacao_id == $mensalidade->mensalidade_precificacao_id ? 'selected' : '') ?>>
                                                    <?php echo $preco->precificacao_categoria ?>
                                                </option>                                                
                                            <?php else: ?>
                                                <option value="<?php echo $preco->precificacao_id . ' ' . $preco->precificacao_valor_mensalidade ?>">
                                                    <?php echo $preco->precificacao_categoria ?>
                                                </option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="">Monthly fee value</label>
                                    <input type="text" class="form-control mensalidade_valor_mensalidade" name="mensalidade_valor_mensalidade" value="<?php echo $currency . ' ' . (isset($mensalidade->mensalidade_valor_mensalidade) ? $mensalidade->mensalidade_valor_mensalidade : '0.00'); ?>" readonly="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control" name="mensalidade_status" <?php echo (isset($mensalidade) && $mensalidade->mensalidade_status == 1 ? 'disabled' : ''); ?>>
                                        <?php if (isset($mensalidade)): ?>
                                            <option value="0" <?php echo ($mensalidade->mensalidade_status == 0 ? 'selected' : '') ?>>Pending</option>
                                            <option value="1" <?php echo ($mensalidade->mensalidade_status == 1 ? 'selected' : '') ?>>Paid</option>
                                        <?php else: ?>
                            ...
                            <?php if (isset($mensalidade) && $mensalidade->mensalidade_status == 1): ?>
                                <button type="submit" class="btn btn-success mr-2" disabled="">Closed</button>
                            <?php else: ?>
                                <a title="Register monthly fee" href="javascript:void(0)" class="btn btn btn-primary mr-2" data-toggle="modal" data-target="#mensalidade">Save</a>                            
                            <?php endif; ?>

                            <a href="<?php echo base_url($this->router->fetch_class()); ?>" class="btn btn-light">Back</a>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="demoModalLabel"><i class="ik ik-alert-octagon text-danger"></i>&nbsp;&nbsp;Data confirmation!</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        </div>
                                        <div class="modal-body">
                                            <span class="text-dark font-weight-bold"><?php echo $texto_modal; ?></span></br>
                                            <p></p>
                                            Click <span class="text-primary font-weight-bold">"Yes"</span> to save.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-success" data-dismiss="modal">No</button>
                                            <button type="submit" class="btn btn-primary mr-2" value="">Yes</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
