                            ...
                            <table class="table data-table table-sm pl-10 pr-10">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo ($mensalista->mensalista_ativo == 1 
                                                ? '<span class="badge badge-pill badge-success mb-1"><i class="fas fa-lock-open"></i>&nbsp;Yes</span>' 
                                                : '<span class="badge badge-pill badge-warning mb-1"><i class="fas fa-lock"></i>&nbsp;No</span>'); ?>
                                        </td>
                                        <td class="text-right">
                                            <a data-toggle="tooltip" data-placement="bottom" title="Edit <?php echo $this->router->fetch_class(); ?>" href="<?php echo base_url($this->router->fetch_class() . '/core/' . $mensalista->mensalista_id); ?>" class="btn btn-icon btn-primary"><i class="ik ik-edit-2"></i></a>
                                            <button type="button" title="Delete <?php echo $this->router->fetch_class(); ?>" class="btn btn-icon btn-danger" data-toggle="modal" data-target="#mensalista-<?php echo $mensalista->mensalista_id; ?>"><i class="ik ik-trash"></i></button>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a data-toggle="tooltip" data-placement="bottom" title="Delete <?php echo $this->router->fetch_class();?>" href="<?php echo base_url($this->router->fetch_class() . '/del/' . $mensalista->mensalista_id); ?>" class="btn btn-danger">Yes, Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
