...
class Home extends CI_Controller {
    ...
    public function __construct () {
        parent::__construct ();
           ...
           $this->lang->load('home', 'english'); // <--- agrega esta línea
    }
    ...
    public function index() {
        ...
        $data = array(
            ...
            'titulo' => $this->lang->line('parking_control'),
            'sub_titulo' => $this->lang->line('welcome_systemcar'),
            'icone_view' => 'fas fa-car',
             'styles' => array(
        ...
        /*Central de notificaçoes */
            ...
            if ($this->home_model->get_mensalidades_vencidas()) {
                ...
                $data['overdue_monthly_payments'] = TRUE;
                $notificacoes++;
            }
